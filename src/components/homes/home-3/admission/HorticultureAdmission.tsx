...
function HorticultureAdmission() {
    return (
        <>
            <Preloader />
            <BreadcrumbEvent title="Apply for Bsc.Horticulture" subtitle="Apply for Bsc.Horticulture" />
            ...
            <div className="appli_container">
                <div className="appli_container1">
                    <h6>Bsc.Horticulture</h6>
                    <p>B.Sc. Horticulture is a four-year undergraduate program designed to provide in-depth knowledge of agricultural science and modern farming practices. The course covers a wide range of subjects including agronomy, soil science, horticulture, agricultural economics, plant breeding, pest management, and sustainable agriculture. Students gain hands-on experience through fieldwork, lab experiments, and rural agricultural work experience programs (RAWE). With the growing focus on food security and sustainable practices, B.Sc. Agriculture opens up diverse career opportunities in government agencies, agribusiness firms, research institutions, and entrepreneurship in the agri-tech space.
