  ...
  return (
    <div className='bm_main'>
      <div className='assets'>
        <img src="/assets/img/medalasset.png" alt="" />
      </div>
      ...
      <div className='bm_chairman'>
        ...
        <div className='content'>
          ...
          <h4>Treasurer</h4>
          <p>As the Treasurer of Sri Manakula Vinayaga Educational Trust, it is my privilege to extend a warm welcome to all. The Sri Manakula Vinayagar School of Agricultural Sciences (SMVCAS) stands as a beacon of knowledge, committed to fostering academic excellence and holistic personal development. Rooted in a legacy of innovation and dedication, our institution strives to provide students with exceptional opportunities for growth and success in the ever-evolving field of agricultural sciences.
            <div>,,</div>
          </p>
