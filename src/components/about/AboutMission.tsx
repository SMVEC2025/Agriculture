        ...
        <div className="am_main">
            ...
            <div className="am_container2">
                ...
                <ul className="list-disc list-inside space-y-1">
                    <li>Academic Block with Smart Classrooms</li>
                    <li>Crop Science Laboratories and Greenhouses</li>
                    <li>Student Hostels (Separate for Boys and Girls)</li>
                    <li>Central Library and Digital Resources</li>
                    <li>Wi-Fi Enabled Learning Spaces</li>
                    <li>Permaculture and Organic Farming Plots</li>
                    <li>ATM, Cafeteria, RO Water Plant</li>
                    <li>24/7 Security and Campus Surveillance</li>
                </ul>
            </div>
