...
function AboutEnd() {
  return (
    <div className="ae_main" style={{backgroundImage:`url('https://img.freepik.com/free-photo/panoramic-view-famous-commerce-square-lisbon-by-night_268835-1413.jpg')`}}>
